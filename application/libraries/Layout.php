...
public function css_preload($archivos = array())
{
foreach ( $archivos as $archivo )
$this->css .= "<link rel=\"preload\" href=\"{$archivo}\" as=\"style\" onload=\"this.onload=null;this.rel='stylesheet'\">
<noscript><link rel=\"stylesheet\" href=\"{$archivo}\"></noscript>";
}
}
