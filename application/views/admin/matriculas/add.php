            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url('matriculas/Matriculas/store');?>" method="POST">
                        ...
                        <div class="form-group">
                                <div class="col-md-12">
                                    <label for="">CURSO APERTURADO:</label>
                                        ...
                                        <input type="text" size="150%" placeholder="Buscar Curso Aperturado" class="form-control" name="apertura" id="apertura" readonly data-toggle="modal" data-target="#modal-inicurso" value="<?php echo set_value("apertura");?>" required>
                                    </div><!-- /input-group -->
                                </div> 
							</div>
							<br> 
                            <div class="form-group">
                                <div class="col-md-2">
									<label for="">&nbsp;</label>
							        <button id="btn-consultar" type="button" class="btn btn-primary"><span class="fa fa-search"></span> Consultar Curso  </button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <label for="">DOCENTE:</label>
                                        ...
                                        <input type="text" size="150%" placeholder="Buscar Docente" class="form-control" name="docente" id="docente" readonly data-toggle="modal" data-target="#modal-docente" value="<?php echo set_value("docente");?>" required>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <label for="">AULA / LUGAR :</label>
                                        ...
                                        <input type="text" size="150%" placeholder="Buscar Aula" class="form-control" name="aula" id="aula" readonly data-toggle="modal" data-target="#modal-aula" value="<?php echo set_value("aula");?>" required>
                                    </div><!-- /input-group -->
                                </div> 
                            <div class="form-group col-md-12">           
                            </div>                            
                            <div class="form-group">
                                 <div class="col-md-3">
                                    ...
                                    <input type="date" name="fecha_ini" class="form-control" id="fecha_ini" value="<?php echo set_value("fecha_ini");?>" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="">FECHA FIN :</label>
                                    <input type="date" name="fecha_fin" class="form-control" id="fecha_fin" value="<?php echo set_value("fecha_fin");?>" required>
                                </div>
                            </div>
                             <div class="form-group col-md-12">           
                            </div>  
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Lita de Docentes</h4>
            </div>
            <div class="modal-body">
