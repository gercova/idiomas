        ...
        $(document).ready(() => {
            ...
            $('#listado').jtable({
               ...
               defaultSorting: 'Orde date ASC', // ordenado ascendente
                ...
                actions: {
                     listAction: '<?php echo site_url(); ?>mantenimiento/tipos/lista',
                ...
                fields: {
                    ...
                    $('.edit-row').click(function(e) {
                        ...
                        console.log(id),
                        //window.location.href = `<?php echo site_url(); ?>administrador/tipos/edit/${id}`;
                        //LoadRecordsButton.click();
  
                        $.ajax({
                                url: base_url + "mantenimiento/tipos/edit",
                                method: "POST",
                                data:{id:id},
                                dataType: "json"
                        })
                            ...
                            // console.log(result);
                                ...
                                $(".modal-title-titulo").text("Editar Tipo");        
                    ...
                    $('.view-row').click(function(e) {
                        ...
                        $.ajax({
                            ...
                            // console.log(result);
                                ...
                                $(".modal-header-color").css("color", "white");
                                $(".modal-title-titulo").text("Datos del Tipo");         
                                $("#modalCRUD").modal("show");      
                            })
                            .fail(function(jqXHR, textStatus, errorThrown) {
                            });
                    ...
                    $('.delete-row').click(function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                console.log(id)
                                const url = `<?php echo site_url(); ?>mantenimiento/tipos/delete/${id}`;
                                fetch(url)
                                    .then(res=>res.json())
                                    .then(res => {
                                        console.log(res)
...
const newRecord = () => {
    $("#form_tipos").trigger("reset");
    $(".modal-header-color").css("background-color", "#007bff");
    $(".modal-header-color").css("color", "white");
    $(".modal-title-titulo").text("Nuevo Tipo");            
    $("#modalCRUD").modal("show");        
    id="";
    }
...
$("#form_tipos").submit(function(e){
   ...
   // console.log(email);
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>mantenimiento/tipos/store",
        type: "POST",
        dataType: "json",
