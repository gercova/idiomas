        ...
        $(document).ready(() => {
            ...
            $('#listado').jtable({
               ...
               defaultSorting: 'Orde date ASC', // ordenado ascendente
                ...
                actions: {
                   listAction: '<?php echo site_url(); ?>registro/docentes/lista',
                ...
                recordsLoaded: (event, data) => {
                    ...
                    $('.edit-row').click(function(e) {
                        ...
                        $.ajax({
                                url: base_url + "registro/docentes/edit",
                                method: "POST",
                                data:{id:id},
                                dataType: "json"
                        })
...
*/
                    ...
                    $('.delete-row').click(function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                console.log(id)
                                const url = `<?php echo site_url(); ?>registro/docentes/delete/${id}`;
                                fetch(url)
                                    .then(res=>res.json())
                                    .then(res => {
                                        console.log(res)
...
$("#form_docentes").submit(function(e){
   ...
   // console.log(email);
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>registro/docentes/store",
        type: "POST",
        dataType: "json",
